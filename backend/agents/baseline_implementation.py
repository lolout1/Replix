...
def train():
    ...
    # Write config
    (output_dir / "config.json").write_text(json.dumps(cfg, indent=2, default=str), encoding="utf-8")
...
async def run_with_sdk(
    ...
    *,
    ...
    if result_path.exists():
        return BaselineResult(**json.loads(result_path.read_text(encoding="utf-8")))
